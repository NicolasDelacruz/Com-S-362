...
public class complaintDatabase {
    ...
    /**
     * This method generates a file to store complaints generated in department class
     * starts first line of the file with "Complaint Database"
     */
    ...
    /**
     * write s in the file
     * @param s - complaint being added to the file generated by generateDataFile()
     */
    ...
    /**
     * write complaint in the file using write(String s)
     * @param e - complaint being added to the list of employee data
     */
